...
public class KlijentFormIzbaci extends javax.swing.JFrame {

   
    public KlijentFormIzbaci() {
        initComponents();
        
        Sesija.getSesija().getMapa().put("status", jTextField1);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            k.izbaci(Integer.parseInt(jTextFieldPozicija.getText()));
        } catch (NumberFormatException | IOException | ClassNotFoundException ex) {
            Logger.getLogger(KlijentFormIzbaci.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KlijentFormIzbaci.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
